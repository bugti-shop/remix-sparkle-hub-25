...
const NotesCalendar = () => {
  ...
  return (
    <div className="min-h-screen min-h-screen-dynamic bg-background <div className="min-h-screen min-h-screen-dynamic bg-background pb-14 flex flex-col"> flex flex-col">
